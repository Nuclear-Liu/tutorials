...
import org.hui.service.core.recommendation.persistence.MongoDbTestBase;
...
class RecommendationServiceApplicationTests extends MongoDbTestBase {
    ...
    private void sendCreateRecommendationEvent(int productId, int recommendationId) {
        ...
        Event<Integer, Recommendation> event = new Event<Integer, Recommendation>(CREATE, productId, recommendation);
